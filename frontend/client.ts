 ...
 */
import { chat as api_notes_chat_chat } from "~backend/notes/chat";
...
export namespace notes {
    ...
    export class ServiceClient {
         ...
         */
        public async chat(params: RequestType<typeof api_notes_chat_chat>): Promise<ResponseType<typeof api_notes_chat_chat>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/notes/chat`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_notes_chat_chat>
        }
         ...
         */
        public async search(params: RequestType<typeof api_notes_search_search>): Promise<ResponseType<typeof api_notes_search_search>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/notes/search`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_notes_search_search>
        }

        /**
         * Uploads and processes Obsidian vault notes.
         */
        public async upload(params: RequestType<typeof api_notes_upload_upload>): Promise<ResponseType<typeof api_notes_upload_upload>> {
            // Now make the actual call to the API
