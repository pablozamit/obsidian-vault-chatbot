...
```bash
git remote add encore encore://obsidian-vault-chatbot-nk6i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/obsidian-vault-chatbot-nk6i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/obsidian-vault-chatbot-nk6i/settings/integrations/github)
